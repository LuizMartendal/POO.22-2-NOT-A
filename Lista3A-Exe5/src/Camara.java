...
public class Camara { // contribuição do Daniel K
    ...
    // estratégia de pedir para cada Partido qual seu pior vereador e comparar apenas entre os piores
	// Assim, há divisão de responsabilidades: parte do código está na Câmara, parte em Partido
